...
public class TripConroller {
    ...
    @PostMapping
    public ResponseEntity<TripCreatResponse> createTrip(@RequestBody TripRequestPayload payload){
    ...
    public ResponseEntity<List<LinkData>> getAllLinks(@PathVariable UUID id){
        List<LinkData> linkList = this.linkService.getAllParticipantsFromEvent(id);
